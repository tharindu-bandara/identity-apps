 ...
 */
interface GoogleTemplateSettingsWizardFormPropsInterface {
    initialValues: any;
...
/**
 * Google template settings wizard form component.
 *
 * @param {GoogleTemplateSettingsWizardFormPropsInterface} props - Props injected to the component.
 * @return {JSX.Element}
 */
export const GoogleTemplateSettingsWizardForm: FunctionComponent<GoogleTemplateSettingsWizardFormPropsInterface> = (
    props: GoogleTemplateSettingsWizardFormPropsInterface
): JSX.Element => {
